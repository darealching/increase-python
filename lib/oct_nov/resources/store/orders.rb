  ...
  module Resources
    class Store
      class Orders
        ...
        #
        # @return [OctNov::Models::Order]
        #
        # @see OctNov::Models::Store::OrderCreateParams
        def create(params = {})
          parsed, options = OctNov::Store::OrderCreateParams.dump_request(params)
          @client.request(
            method: :post,
            path: "store/order",
            body: parsed,
        ...
        # @return [OctNov::Models::Order]
        #
        # @see OctNov::Models::Store::OrderRetrieveParams
        ...
        # @return [nil]
        #
        # @see OctNov::Models::Store::OrderDeleteParams
