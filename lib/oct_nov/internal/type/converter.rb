    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { OctNov::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { OctNov::Internal::Type::Unknown.dump(_1, state: state) }
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in OctNov::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [OctNov::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: OctNov::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in OctNov::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in OctNov::Internal::Type::Converter
              ...
              OctNov::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(OctNov::Internal::Type::Converter, T::Class[T.anything]) }
        end
