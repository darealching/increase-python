...
class OctNov::Test::PrimitiveModelTest < Minitest::Test
  A = OctNov::Internal::Type::ArrayOf[-> { Integer }]
  H = OctNov::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend OctNov::Internal::Type::Union
  end

  class B < OctNov::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      OctNov::Internal::Type::Unknown,
      OctNov::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => OctNov::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [OctNov::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [OctNov::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [OctNov::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = OctNov::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        OctNov::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [OctNov::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [OctNov::Internal::Type::Boolean, true] => true,
      [OctNov::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => OctNov::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        OctNov::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = OctNov::Internal::Type::Converter.new_coerce_state
      OctNov::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        OctNov::Internal::Type::Converter.dump(target, input, state: state)
...
class OctNov::Test::EnumModelTest < Minitest::Test
  class E0
    include OctNov::Internal::Type::Enum
...
class OctNov::Test::CollectionModelTest < Minitest::Test
  A1 = OctNov::Internal::Type::ArrayOf[-> { Integer }]
  H1 = OctNov::Internal::Type::HashOf[Integer]

  A2 = OctNov::Internal::Type::ArrayOf[H1]
  H2 = OctNov::Internal::Type::HashOf[-> { A1 }]

  A3 = OctNov::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = OctNov::Internal::Type::HashOf[Integer, nil?: true]
...
class OctNov::Test::BaseModelTest < Minitest::Test
  class M1 < OctNov::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < OctNov::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < OctNov::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, OctNov::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = OctNov::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = OctNov::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(OctNov::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue OctNov::Errors::ConversionError => e
...
class OctNov::Test::UnionTest < Minitest::Test
  class U0
    include OctNov::Internal::Type::Union
  ...
  class M2 < OctNov::Internal::Type::BaseModel
  ...
  class M4 < OctNov::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, OctNov::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < OctNov::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, OctNov::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class OctNov::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include OctNov::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [OctNov::Internal::Type::Unknown, OctNov::Internal::Type::Unknown] => true,
      [OctNov::Internal::Type::Boolean, OctNov::Internal::Type::Boolean] => true,
      [OctNov::Internal::Type::Unknown, OctNov::Internal::Type::Boolean] => false,
...
class OctNov::Test::MetaInfoTest < Minitest::Test
  A1 = OctNov::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = OctNov::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
